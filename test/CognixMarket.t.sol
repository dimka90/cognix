...
contract CognixMarketTest is Test {
    ...
    function testCompleteTask() public {
        ...
        // Initial 10 + 1 (reward) - 0.025 (2.5% fee) = 10.975
        assertEq(agent.balance, agentBalanceBefore + 0.975 ether);
    ...
    function testRaiseAndResolveDispute() public {
        ...
        // Initial 10 + 1 (reward) - 0.01 (1% artibration fee) = 10.99
        assertEq(agent.balance, agentBalanceBefore + 0.99 ether);
    }
}