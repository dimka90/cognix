...
contract CognixToken is Ownable, Pausable {
    ...
    function burn(uint256 amount) external whenNotPaused {
        uint256 senderBalance = balanceOf[msg.sender];
        require(senderBalance >= amount, "Insufficient balance to burn");
    ...
    function burnFrom(address account, uint256 amount) external whenNotPaused {
        ...
        require(accountBalance >= amount, "Insufficient balance to burn");
        
        uint256 currentAllowance = allowance[account][msg.sender];
        require(currentAllowance >= amount, "Insufficient allowance to burn");
